...
// Assuming you have an array of weather data for five days
const weatherDataForFiveDays = [
  { code: 800 }, // Day 1 weather code
  { code: 300 }, // Day 2 weather code
  { code: 600 }, // Day 3 weather code
  { code: 500 }, // Day 4 weather code
  { code: 200 }, // Day 5 weather code
];

// Loop through the weather data and call setForeIcon for each day
for (let i = 0; i < weatherDataForFiveDays.length; i++) {
  setForeIcon(weatherDataForFiveDays[i].code, i + 1);
}
